<template>
  ...
  >
    <el-tabs v-model="activeName" @tab-click="handleClick">
      ...
      <el-tab-pane label="案件主体" name="second"></el-tab-pane>
    </el-tabs>
    ...
    <template v-else>
      ...
      <el-row>
        <el-col :span="24" class="liti__title">
          <span class="w2">身份</span>
          <span class="w4">姓名</span>
          <span class="w4">联系方式</span>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="24">
          <ul>
            <li class="liti__content" v-for="(item,index) in litigantList" :key="index">
              ...
              <span class="w4" style="color:#0052D9">{{item.phoneId}}</span>
            </li>
          </ul>
        </el-col>
      </el-row>
