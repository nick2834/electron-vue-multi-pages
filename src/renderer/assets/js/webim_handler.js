...
function sdkLogin(userInfo, listeners, options, avChatRoomId) {
  ...
  webim.login(userInfo, listeners, options,
    ...
    function (err) {
      ...
      sdkLogin(userInfo, listeners, options, avChatRoomId)
    }
  ); //
}
...
function convertCustomMsgToHtml(content) {
  // console.log(content[0].elems[0].content.data)
  var data = content.getData();
  // var data = JSON.parse(content[0].elems[0].content.data).messageBody;
...
export default {
  ...
  addGroupSystemMsg: addGroupSystemMsg
};